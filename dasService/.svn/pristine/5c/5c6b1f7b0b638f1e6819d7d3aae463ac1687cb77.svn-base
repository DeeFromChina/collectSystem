...
public class CollectTillitemstatus extends CollectionBase implements CollectionInterface {

   private static Logger logger = Logger.getLogger(CollectTillitemstatus.class);

   public CollectTillitemstatus() {
      this.fileName = "tillitemstatus";
      this.primaryKey = "tillitemnum";
      this.dataName = "POS交易";
      this.tableName = "tillitemstatus";
   }
   ...
   public String prepareSql(Map<String, Object> parameters) {
      ...
      StringBuffer sb = new StringBuffer("select p.* from till t,tillitem b,tillitemstatus p ");
      sb.append(" where t.pos_batch_id=b.pos_batch_id and t.tillnum=b.tillnum and p.tillitemnum=b.sernum ");
      try {
