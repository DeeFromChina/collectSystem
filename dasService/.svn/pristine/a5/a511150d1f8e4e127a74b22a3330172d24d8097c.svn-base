...
public class CollectTillitem extends CollectionBase implements CollectionInterface {

   private static Logger logger = Logger.getLogger(CollectTillitem.class);

   public CollectTillitem() {
      this.fileName = "tillitem";
      this.primaryKey = "sernum";
      this.dataName = "POS交易细项表";
      this.tableName = "tillitem";
   }
   ...
   public String prepareSql(Map<String, Object> parameters) {
      ...
      StringBuffer sb = new StringBuffer("select b.* from till t,tillitem b ");
