...
public class CollectTillloyalty extends CollectionBase implements CollectionInterface {

   private static Logger logger = Logger.getLogger(CollectTillloyalty.class);

   public CollectTillloyalty() {
      this.fileName = "tillloyalty";
      this.primaryKey = "pos_batch_id;tillnum";
      this.dataName = "POS交易表";
      this.tableName = "tillloyalty";
   }
   ...
   public String prepareSql(Map<String, Object> parameters) {
      ...
      StringBuffer sb = new StringBuffer("select b.* from till t,tillloyalty b ");
