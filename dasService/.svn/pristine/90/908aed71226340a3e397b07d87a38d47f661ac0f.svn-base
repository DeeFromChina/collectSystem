...
public class CollectFuelPumpReading extends CollectionBase implements CollectionInterface {

   private static Logger logger = Logger.getLogger(CollectFuelPumpReading.class);

   public CollectFuelPumpReading() {
      this.fileName = "fuelPumpReading";
      this.primaryKey = "shift_control_id;pump_id;hose_id";
      this.dataName = "油枪油品帐数据表";
      this.tableName = "fuel_pump_reading";
   }
   ...
   public String prepareSql(Map<String, Object> parameters) {
      ...
      StringBuffer sb = new StringBuffer("select r.* from daybatch t,fuel_shift_control b,fuel_pump_reading r ");
