...
public class CollectItemdoclink extends CollectionBase implements CollectionInterface {

   private static Logger logger = Logger.getLogger(CollectItemdoclink.class);

   public CollectItemdoclink() {
      this.fileName = "itemdoclink";
      this.primaryKey = "link_ref;doc_ref";
      this.dataName = "itemdoctrans的关联表";
      this.tableName = "itemdoclink";
   }
   ...
   public String prepareSql(Map<String, Object> parameters) {
      ...
      StringBuffer sb = new StringBuffer("select l.* from itemdoctrans t,itemdoclink l where l.doc_ref=t.itemdoc_id");
      try {
