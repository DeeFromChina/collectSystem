...
public class CollectTillpmntCrdtTrl extends CollectionBase implements CollectionInterface {

   private static Logger logger = Logger.getLogger(CollectTillpmntCrdtTrl.class);

   public CollectTillpmntCrdtTrl() {
      this.fileName = "tillpmntCrdtTrl";
      this.primaryKey = "sernum";
      this.dataName = "POS交易支付信息-银行卡支付";
      this.tableName = "tillpmnt_crdt_trl";
   }
   ...
   public String prepareSql(Map<String, Object> parameters) {
      ...
      StringBuffer sb = new StringBuffer("select c.* from till t,tillbill b,tillpmnt p,tillpmnt_crdt_trl c ");
