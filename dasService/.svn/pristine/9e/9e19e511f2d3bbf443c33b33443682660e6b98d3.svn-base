...
public class LogTransferProcess extends Thread {
   ...
   public LogTransferProcess(Map<String, Object> initParameters) {
      ...
      this.stationID = initParameters.get("company.stationID").toString();
   }
   ...
   private boolean uploadFile(String saveName, File file) {
      ...
      try {
         ...
         if (!setupWorkingDirectory(properties.getProperty("company.companyNo") + File.separator + properties.getProperty("company.stationID"))) return false;
