...
public class CollectFuelShiftControl extends CollectionBase implements CollectionInterface {

   private static Logger logger = Logger.getLogger(CollectFuelShiftControl.class);

   public CollectFuelShiftControl() {
      this.fileName = "fuelShiftControl";
      this.primaryKey = "shift_control_id";
      this.dataName = "加油站油品帐交接表";
      this.tableName = "fuel_shift_control";
   }
   ...
   public String prepareSql(Map<String, Object> parameters) {
      ...
      StringBuffer sb = new StringBuffer("select b.* from daybatch t,fuel_shift_control b ");
      sb.append(" where t.day_batch_id=b.day_batch_id  ");
      try {
