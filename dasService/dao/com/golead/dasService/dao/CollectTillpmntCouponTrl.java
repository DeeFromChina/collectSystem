...
public class CollectTillpmntCouponTrl extends CollectionBase implements CollectionInterface {

   private static Logger logger = Logger.getLogger(CollectTillpmntCouponTrl.class);

   public CollectTillpmntCouponTrl() {
      this.fileName = "tillpmntCouponTrl";
      this.primaryKey = "sernum";
      this.dataName = "POS交易支付信息-优惠券支付";
      this.tableName = "tillpmnt_coupon_trl";
   }
   ...
   public String prepareSql(Map<String, Object> parameters) {
      ...
      StringBuffer sb = new StringBuffer("select c.* from till t,tillbill b,tillpmnt p,tillpmnt_coupon_trl c ");
