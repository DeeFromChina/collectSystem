...
public class CollectTillitempromo extends CollectionBase implements CollectionInterface {

   private static Logger logger = Logger.getLogger(CollectTillitempromo.class);

   public CollectTillitempromo() {
      this.fileName = "tillitempromo";
      this.primaryKey = "tillitem_sernum;promo_id";
      this.dataName = "POS交易";
      this.tableName = "tillitempromo";
   }
   ...
   public String prepareSql(Map<String, Object> parameters) {
      ...
      StringBuffer sb = new StringBuffer("select p.* from till t,tillitem b,tillitempromo p ");
      sb.append(" where t.pos_batch_id=b.pos_batch_id and t.tillnum=b.tillnum and p.tillitem_sernum=b.sernum ");
      try {
