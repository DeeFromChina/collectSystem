...
public class CollectPmntlinetrans extends CollectionBase implements CollectionInterface {

   private static Logger logger = Logger.getLogger(CollectPmntlinetrans.class);

   public CollectPmntlinetrans() {
      this.fileName = "pmntlinetrans";
      this.primaryKey = "sernum";
      this.dataName = "投币缴存表";
      this.tableName = "pmntlinetrans";
   }
   ...
   public String prepareSql(Map<String, Object> parameters) {
      ...
      StringBuffer sb = new StringBuffer("select l.* from pmntlinetrans l,pmntdoctrans t where l.docref=t.docref");
      try {
