...
public class CollectFuelTankDeliveryDoc extends CollectionBase implements CollectionInterface {

   private static Logger logger = Logger.getLogger(CollectFuelTankDeliveryDoc.class);

   public CollectFuelTankDeliveryDoc() {
      this.fileName = "fuelTankDeliveryDoc";
      this.primaryKey = "headerid;tank_id;truck_tank_id";
      this.dataName = "油罐加油入库原发数据表";
      this.tableName = "fuel_tank_delivery_doc";
   }
   ...
   public String prepareSql(Map<String, Object> parameters) {
      ...
      StringBuffer sb = new StringBuffer("select r.* from daybatch t,fuel_shift_control b,fuel_tank_delivery_header h,fuel_tank_delivery_document r ");
