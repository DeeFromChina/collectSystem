...
public class CommunicationClientHandler extends SimpleChannelInboundHandler<String> {
   ...
   public void channelActive(ChannelHandlerContext ctx) throws Exception {
      ...
      communicationClientCallback.command(ctx.channel().remoteAddress().toString(), CommunicationClientCallback.COMMAND_CONNECT + ":0,连接成功");
   }
   ...
   public void channelInactive(ChannelHandlerContext ctx) throws Exception {
      ...
      communicationClientCallback.command(ctx.channel().remoteAddress().toString(), CommunicationClientCallback.COMMAND_DISCONNECT + ":0,已经断开");
   }
